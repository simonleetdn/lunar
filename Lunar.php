...
class HolidayUtil
{
  ...
  /**
   * 修正或追加節假日數據。節假日名稱下標從0開始，超過9的，按ASCII碼表依次往後排列；調休標識0為上班，否則放假
   * @param array $names 用於替換默認的節假日名稱列表，傳null即可使用默認名稱
   * @param string $data 需要修正或追加的節假日數據，每18位表示1天依次排列，格式：當天年月日YYYYMMDD(8位)+節假日名稱下標(1位)+調休標識(1位)+節假日當天YYYYMMDD(8位)。例：202005023120200501代表2020-05-02為勞動節放假，對應節假日為2020-05-01
   */
...
class FotoUtil
{
  ...
  public static $XIU_27 = array('角', '亢', '氐', '房', '心', '尾', '箕', '鬥', '女', '虛', '危', '室', '壁', '奎', '婁', '胃', '昴', '畢', '觜', '參', '井', '鬼', '柳', '星', '張', '翼', '軫');
  ...
  private static function init()
  {
    ...
    $Y = new FotoFestival('楊公忌');
    $T = new FotoFestival('四天王巡行', '', true);
    $D = new FotoFestival('鬥降', $DJ, true);
    $S = new FotoFestival('月朔', $DJ, true);
    $W = new FotoFestival('月望', $DJ, true);
    $H = new FotoFestival('月晦', $JS, true);
    $L = new FotoFestival('雷齋日', $JS, true);
    $J = new FotoFestival('九毒日', '犯者夭亡，奇禍不測');
    $R = new FotoFestival('人神在陰', '犯者得病', true, '宜先一日即戒');
    $M = new FotoFestival('司命奏事', $JS, true, '如月小，即戒廿九');
    $HH = new FotoFestival('月晦', $JS, true, '如月小，即戒廿九');

    self::$FESTIVAL = array(
      '1-1' => array(new FotoFestival('天臘，玉帝校世人神氣祿命', $XL), $S),
      '1-3' => array(new FotoFestival('萬神都會', $DJ), $D),
      '1-5' => array(new FotoFestival('五虛忌')),
      '1-6' => array(new FotoFestival('六耗忌'), $L),
      '1-7' => array(new FotoFestival('上會日', $SS)),
      '1-8' => array(new FotoFestival('五殿閻羅天子誕', $DJ), $T),
      '1-9' => array(new FotoFestival('玉皇上帝誕', $DJ)),
      '1-13' => array($Y),
      '1-14' => array(new FotoFestival('三元降', $JS), $T),
      '1-15' => array(new FotoFestival('三元降', $JS), new FotoFestival('上元神會', $DJ), $W, $T),
      '1-16' => array(new FotoFestival('三元降', $JS)),
      '1-19' => array(new FotoFestival('長春真人誕')),
      '1-23' => array(new FotoFestival('三屍神奏事'), $T),
      '1-25' => array($H, new FotoFestival('天地倉開日', '犯者損壽，子帶疾')),
      '1-27' => array($D),
      '1-28' => array($R),
      '1-29' => array($T),
      '1-30' => array($HH, $M, $T),
      '2-1' => array(new FotoFestival('一殿秦廣王誕', $DJ), $S),
      '2-2' => array(new FotoFestival('萬神都會', $DJ), new FotoFestival('福德土地正神誕', '犯者得禍')),
      '2-3' => array(new FotoFestival('文昌帝君誕', $XL), $D),
      '2-6' => array(new FotoFestival('東華帝君誕'), $L),
      '2-8' => array(new FotoFestival('釋迦牟尼佛出家', $DJ), new FotoFestival('三殿宋帝王誕', $DJ), new FotoFestival('張大帝誕', $DJ), $T),
      '2-11' => array($Y),
      '2-14' => array($T),
      '2-15' => array(new FotoFestival('釋迦牟尼佛涅槃', $XL), new FotoFestival('太上老君誕', $XL), new FotoFestival('月望', $XL, true), $T),
      '2-17' => array(new FotoFestival('東方杜將軍誕')),
      '2-18' => array(new FotoFestival('四殿五官王誕', $XL), new FotoFestival('至聖先師孔子諱辰', $XL)),
      '2-19' => array(new FotoFestival('觀音大士誕', $DJ)),
      '2-21' => array(new FotoFestival('普賢菩薩誕')),
      '2-23' => array($T),
      '2-25' => array($H),
      '2-27' => array($D),
      '2-28' => array($R),
      '2-29' => array($T),
      '2-30' => array($HH, $M, $T),
      '3-1' => array(new FotoFestival('二殿楚江王誕', $DJ), $S),
      '3-3' => array(new FotoFestival('玄天上帝誕', $DJ), $D),
      '3-6' => array($L),
      '3-8' => array(new FotoFestival('六殿卞城王誕', $DJ), $T),
      '3-9' => array(new FotoFestival('牛鬼神出', '犯者產惡胎'), $Y),
      '3-12' => array(new FotoFestival('中央五道誕')),
      '3-14' => array($T),
      '3-15' => array(new FotoFestival('昊天上帝誕', $DJ), new FotoFestival('玄壇誕', $DJ), $W, $T),
      '3-16' => array(new FotoFestival('準提菩薩誕', $DJ)),
      '3-19' => array(new FotoFestival('中岳大帝誕'), new FotoFestival('後土娘娘誕'), new FotoFestival('三茅降')),
      '3-20' => array(new FotoFestival('天地倉開日', $SS), new FotoFestival('子孫娘娘誕')),
      '3-23' => array($T),
      '3-25' => array($H),
      '3-27' => array(new FotoFestival('七殿泰山王誕'), $D),
      '3-28' => array($R, new FotoFestival('蒼頡至聖先師誕', $XL), new FotoFestival('東岳大帝誕')),
      '3-29' => array($T),
      '3-30' => array($HH, $M, $T),
      '4-1' => array(new FotoFestival('八殿都市王誕', $DJ), $S),
      '4-3' => array($D),
      '4-4' => array(new FotoFestival('萬神善會', '犯者失瘼夭胎'), new FotoFestival('文殊菩薩誕')),
      '4-6' => array($L),
      '4-7' => array(new FotoFestival('南鬥、北鬥、西鬥同降', $JS), $Y),
      '4-8' => array(new FotoFestival('釋迦牟尼佛誕', $DJ), new FotoFestival('萬神善會', '犯者失瘼夭胎'), new FotoFestival('善惡童子降', '犯者血死'), new FotoFestival('九殿平等王誕'), $T),
      '4-14' => array(new FotoFestival('純陽祖師誕', $JS), $T),
      '4-15' => array($W, new FotoFestival('鐘離祖師誕'), $T),
      '4-16' => array(new FotoFestival('天地倉開日', $SS)),
      '4-17' => array(new FotoFestival('十殿轉輪王誕', $DJ)),
      '4-18' => array(new FotoFestival('天地倉開日', $SS), new FotoFestival('紫徽大帝誕', $SS)),
      '4-20' => array(new FotoFestival('眼光聖母誕')),
      '4-23' => array($T),
      '4-25' => array($H),
      '4-27' => array($D),
      '4-28' => array($R),
      '4-29' => array($T),
      '4-30' => array($HH, $M, $T),
      '5-1' => array(new FotoFestival('南極長生大帝誕', $DJ), $S),
      '5-3' => array($D),
      '5-5' => array(new FotoFestival('地臘', $XL), new FotoFestival('五帝校定生人官爵', $XL), $J, $Y),
      '5-6' => array($J, $L),
      '5-7' => array($J),
      '5-8' => array(new FotoFestival('南方五道誕'), $T),
      '5-11' => array(new FotoFestival('天地倉開日', $SS), new FotoFestival('天下都城隍誕')),
      '5-12' => array(new FotoFestival('炳靈公誕')),
      '5-13' => array(new FotoFestival('關聖降', $XL)),
      '5-14' => array(new FotoFestival('夜子時為天地交泰', $JW), $T),
      '5-15' => array($W, $J, $T),
      '5-16' => array(new FotoFestival('九毒日', $JW), new FotoFestival('天地元氣造化萬物之辰', $JW)),
      '5-17' => array($J),
      '5-18' => array(new FotoFestival('張天師誕')),
      '5-22' => array(new FotoFestival('孝娥神誕', $DJ)),
      '5-23' => array($T),
      '5-25' => array($J, $H),
      '5-26' => array($J),
      '5-27' => array($J, $D),
      ...
      '5-30' => array($HH, $M, $T),
      '6-1' => array($S),
      '6-3' => array(new FotoFestival('韋馱菩薩聖誕'), $D, $Y),
      '6-5' => array(new FotoFestival('南贍部洲轉大輪', $SS)),
      '6-6' => array(new FotoFestival('天地倉開日', $SS), $L),
      '6-8' => array($T),
      '6-10' => array(new FotoFestival('金粟如來誕')),
      '6-14' => array($T),
      '6-15' => array($W, $T),
      '6-19' => array(new FotoFestival('觀世音菩薩成道', $DJ)),
      '6-23' => array(new FotoFestival('南方火神誕', '犯者遭回祿'), $T),
      '6-24' => array(new FotoFestival('雷祖誕', $XL), new FotoFestival('關帝誕', $XL)),
      '6-25' => array($H),
      '6-27' => array($D),
      '6-28' => array($R),
      '6-29' => array($T),
      ...
      '7-1' => array($S, $Y),
      '7-3' => array($D),
      '7-5' => array(new FotoFestival('中會日', $SS, false, '一作初七')),
      '7-6' => array($L),
      '7-7' => array(new FotoFestival('道德臘', $XL), new FotoFestival('五帝校生人善惡', $XL), new FotoFestival('魁星誕', $XL)),
      '7-8' => array($T),
      '7-10' => array(new FotoFestival('陰毒日', '', false, '大忌')),
      '7-12' => array(new FotoFestival('長真譚真人誕')),
      '7-13' => array(new FotoFestival('大勢至菩薩誕', $JS)),
      ...
      '7-18' => array(new FotoFestival('西王母誕', $DJ)),
      '7-19' => array(new FotoFestival('太歲誕', $DJ)),
      '7-22' => array(new FotoFestival('增福財神誕', $XL)),
      '7-23' => array($T),
      '7-25' => array($H),
      '7-27' => array($D),
      '7-28' => array($R),
      '7-29' => array($Y, $T),
      '7-30' => array(new FotoFestival('地藏菩薩誕', $DJ), $HH, $M, $T),
      '8-1' => array($S, new FotoFestival('許真君誕')),
      '8-3' => array($D, new FotoFestival('北鬥誕', $XL), new FotoFestival('司命竈君誕', '犯者遭回祿')),
      '8-5' => array(new FotoFestival('雷聲大帝誕', $DJ)),
      '8-6' => array($L),
      '8-8' => array($T),
      '8-10' => array(new FotoFestival('北鬥大帝誕')),
      '8-12' => array(new FotoFestival('西方五道誕')),
      '8-14' => array($T),
      '8-15' => array($W, new FotoFestival('太明朝元', '犯者暴亡', false, '宜焚香守夜'), $T),
      '8-16' => array(new FotoFestival('天曹掠刷真君降', '犯者貧夭')),
      '8-18' => array(new FotoFestival('天人興福之辰', '', false, '宜齋戒，存想吉事')),
      '8-23' => array(new FotoFestival('漢恒候張顯王誕'), $T),
      '8-24' => array(new FotoFestival('竈君夫人誕')),
      '8-25' => array($H),
      '8-27' => array($D, new FotoFestival('至聖先師孔子誕', $XL), $Y),
      '8-28' => array($R, new FotoFestival('四天會事')),
      '8-29' => array($T),
      '8-30' => array(new FotoFestival('諸神考校', '犯者奪算'), $HH, $M, $T),
      '9-1' => array($S, new FotoFestival('南鬥誕', $XL), new FotoFestival('北鬥九星降世', $DJ, false, '此九日俱宜齋戒')),
      '9-3' => array($D, new FotoFestival('五瘟神誕')),
      '9-6' => array($L),
      '9-8' => array($T),
      '9-9' => array(new FotoFestival('鬥母誕', $XL), new FotoFestival('酆都大帝誕'), new FotoFestival('玄天上帝飛升')),
      '9-10' => array(new FotoFestival('鬥母降', $DJ)),
      '9-11' => array(new FotoFestival('宜戒')),
      '9-13' => array(new FotoFestival('孟婆尊神誕')),
      '9-14' => array($T),
      '9-15' => array($W, $T),
      '9-17' => array(new FotoFestival('金龍四大王誕', '犯者遭水厄')),
      '9-19' => array(new FotoFestival('日宮月宮會合', $JS), new FotoFestival('觀世音菩薩誕', $JS)),
      '9-23' => array($T),
      '9-25' => array($H, $Y),
      '9-27' => array($D),
      '9-28' => array($R),
      '9-29' => array($T),
      '9-30' => array(new FotoFestival('藥師琉璃光佛誕', '犯者危疾'), $HH, $M, $T),
      '10-1' => array($S, new FotoFestival('民歲臘', $DJ), new FotoFestival('四天王降', '犯者一年內死')),
      '10-3' => array($D, new FotoFestival('三茅誕')),
      '10-5' => array(new FotoFestival('下會日', $JS), new FotoFestival('達摩祖師誕', $JS)),
      '10-6' => array($L, new FotoFestival('天曹考察', $DJ)),
      '10-8' => array(new FotoFestival('佛涅槃日', '', false, '大忌色欲'), $T),
      '10-10' => array(new FotoFestival('四天王降', '犯者一年內死')),
      ...
      '10-23' => array($Y, $T),
      '10-25' => array($H),
      '10-27' => array($D, new FotoFestival('北極紫徽大帝降')),
      '10-28' => array($R),
      '10-29' => array($T),
      '10-30' => array($HH, $M, $T),
      '11-1' => array($S),
      '11-3' => array($D),
      '11-4' => array(new FotoFestival('至聖先師孔子誕', $XL)),
      '11-6' => array(new FotoFestival('西岳大帝誕')),
      '11-8' => array($T),
      '11-11' => array(new FotoFestival('天地倉開日', $DJ), new FotoFestival('太乙救苦天尊誕', $DJ)),
      '11-14' => array($T),
      '11-15' => array(new FotoFestival('月望', '上半夜犯男死 下半夜犯女死'), new FotoFestival('四天王巡行', '上半夜犯男死 下半夜犯女死')),
      '11-17' => array(new FotoFestival('阿彌陀佛誕')),
      '11-19' => array(new FotoFestival('太陽日宮誕', '犯者得奇禍')),
      '11-21' => array($Y),
      '11-23' => array(new FotoFestival('張仙誕', '犯者絕嗣'), $T),
      '11-25' => array(new FotoFestival('掠刷大夫降', '犯者遭大兇'), $H),
      '11-26' => array(new FotoFestival('北方五道誕')),
      '11-27' => array($D),
      '11-28' => array($R),
      '11-29' => array($T),
      '11-30' => array($HH, $M, $T),
      '12-1' => array($S),
      '12-3' => array($D),
      '12-6' => array(new FotoFestival('天地倉開日', $JS), $L),
      '12-7' => array(new FotoFestival('掠刷大夫降', '犯者得惡疾')),
      '12-8' => array(new FotoFestival('王侯臘', $DJ), new FotoFestival('釋迦如來成佛之辰'), $T, new FotoFestival('初旬內戊日，亦名王侯臘', $DJ)),
      '12-12' => array(new FotoFestival('太素三元君朝真')),
      '12-14' => array($T),
      '12-15' => array($W, $T),
      '12-16' => array(new FotoFestival('南岳大帝誕')),
      '12-19' => array($Y),
      '12-20' => array(new FotoFestival('天地交道', '犯者促壽')),
      '12-21' => array(new FotoFestival('天猷上帝誕')),
      '12-23' => array(new FotoFestival('五岳誕降'), $T),
      '12-24' => array(new FotoFestival('司今朝天奏人善惡', '犯者得大禍')),
      '12-25' => array(new FotoFestival('三清玉帝同降，考察善惡', '犯者得奇禍'), $H),
      '12-27' => array($D),
      '12-28' => array($R),
      '12-29' => array(new FotoFestival('華嚴菩薩誕'), $T),
      '12-30' => array(new FotoFestival('諸神下降，察訪善惡', '犯者男女俱亡'))
    );
  }
...
class TaoUtil
{
   ...
   * @var string[]
   */
  public static $AN_WU = array('未', '戌', '辰', '寅', '午', '子', '酉', '申', '巳', '亥', '卯', '醜');
...
class LunarUtil
{
  ...
  public static $XUN_KONG = array('戌亥', '申酉', '午未', '辰巳', '寅卯', '子醜');
  public static $LIU_YAO = array('先勝', '友引', '先負', '佛滅', '大安', '赤口');
  public static $HOU = array('初候', '二候', '三候');
  public static $WU_HOU = array('蚯蚓結', '麋角解', '水泉動', '雁北鄉', '鵲始巢', '雉始雊', '雞始乳', '征鳥厲疾', '水澤腹堅', '東風解凍', '蟄蟲始振', '魚陟負冰', '獺祭魚', '候雁北', '草木萌動', '桃始華', '倉庚鳴', '鷹化為鳩', '玄鳥至', '雷乃發聲', '始電', '桐始華', '田鼠化為鴽', '虹始見', '萍始生', '鳴鳩拂奇羽', '戴勝降於桑', '螻蟈鳴', '蚯蚓出', '王瓜生', '苦菜秀', '靡草死', '麥秋至', '螳螂生', '鵙始鳴', '反舌無聲', '鹿角解', '蜩始鳴', '半夏生', '溫風至', '蟋蟀居壁', '鷹始摯', '腐草為螢', '土潤溽暑', '大雨行時', '涼風至', '白露降', '寒蟬鳴', '鷹乃祭鳥', '天地始肅', '禾乃登', '鴻雁來', '玄鳥歸', '群鳥養羞', '雷始收聲', '蟄蟲坯戶', '水始涸', '鴻雁來賓', '雀入大水為蛤', '菊有黃花', '豺乃祭獸', '草木黃落', '蟄蟲鹹俯', '水始冰', '地始凍', '雉入大水為蜃', '虹藏不見', '天氣上升地氣下降', '閉塞而成冬', '鹖鴠不鳴', '虎始交', '荔挺出');
  public static $GAN = array('', '甲', '乙', '丙', '丁', '戊', '己', '庚', '辛', '壬', '癸');
  public static $POSITION_XI = array('', '艮', '乾', '坤', '離', '巽', '艮', '乾', '坤', '離', '巽');
  public static $POSITION_YANG_GUI = array('', '坤', '坤', '兌', '乾', '艮', '坎', '離', '艮', '震', '巽');
  public static $POSITION_YIN_GUI = array('', '艮', '坎', '乾', '兌', '坤', '坤', '艮', '離', '巽', '震');
  public static $POSITION_FU = array('', '巽', '巽', '震', '震', '坎', '離', '坤', '坤', '乾', '兌');
  public static $POSITION_FU_2 = array('', '坎', '坤', '乾', '巽', '艮', '坎', '坤', '乾', '巽', '艮');
  public static $POSITION_CAI = array('', '艮', '艮', '坤', '坤', '坎', '坎', '震', '震', '離', '離');
  public static $POSITION_TAI_SUI_YEAR = array('坎', '艮', '艮', '震', '巽', '巽', '離', '坤', '坤', '兌', '坎', '坎');
  public static $POSITION_GAN = array('震', '震', '離', '離', '中', '中', '兌', '兌', '坎', '坎');
  public static $POSITION_ZHI = array('坎', '中', '震', '震', '中', '離', '離', '中', '兌', '兌', '中', '坎');
  public static $POSITION_TAI_DAY = array(
    '占門碓 外東南', '碓磨廁 外東南', '廚竈爐 外正南', '倉庫門 外正南', '房床棲 外正南', '占門床 外正南', '占碓磨 外正南', '廚竈廁 外西南', '倉庫爐 外西南', '房床門 外西南',
    '占門棲 外西南', '碓磨床 外西南', '廚竈碓 外西南', '倉庫廁 外正西', '房床爐 外正西', '占大門 外正西', '碓磨棲 外正西', '廚竈床 外正西', '倉庫碓 外西北', '房床廁 外西北',
    '占門爐 外西北', '碓磨門 外西北', '廚竈棲 外西北', '倉庫床 外西北', '房床碓 外正北', '占門廁 外正北', '碓磨爐 外正北', '廚竈門 外正北', '倉庫棲 外正北', '占房床 房內北',
    '占門碓 房內北', '碓磨廁 房內北', '廚竈爐 房內北', '倉庫門 房內北', '床房棲 房內中', '占門床 房內中', '占碓磨 房內南', '廚竈廁 房內南', '倉庫爐 房內南', '房床門 房內西',
    '占門棲 房內東', '碓磨床 房內東', '廚竈碓 房內東', '倉庫廁 房內東', '房床爐 房內中', '占大門 外東北', '碓磨棲 外東北', '廚竈床 外東北', '倉庫碓 外東北', '房床廁 外東北',
    '占門爐 外東北', '碓磨門 外正東', '廚竈棲 外正東', '倉庫床 外正東', '房床碓 外正東', '占門廁 外正東', '碓磨爐 外東南', '廚竈門 外東南', '倉庫棲 外東南', '占房床 外東南'
  );
  public static $POSITION_TAI_MONTH = array('占房床', '占戶窗', '占門堂', '占廚竈', '占房床', '占床倉', '占碓磨', '占廁戶', '占門房', '占房床', '占竈爐', '占房床');
  public static $ZHI = array('', '子', '醜', '寅', '卯', '辰', '巳', '午', '未', '申', '酉', '戌', '亥');
  public static $JIA_ZI = array('甲子', '乙醜', '丙寅', '丁卯', '戊辰', '己巳', '庚午', '辛未', '壬申', '癸酉', '甲戌', '乙亥', '丙子', '丁醜', '戊寅', '己卯', '庚辰', '辛巳', '壬午', '癸未', '甲申', '乙酉', '丙戌', '丁亥', '戊子', '己醜', '庚寅', '辛卯', '壬辰', '癸巳', '甲午', '乙未', '丙申', '丁酉', '戊戌', '己亥', '庚子', '辛醜', '壬寅', '癸卯', '甲辰', '乙巳', '丙午', '丁未', '戊申', '己酉', '庚戌', '辛亥', '壬子', '癸醜', '甲寅', '乙卯', '丙辰', '丁巳', '戊午', '己未', '庚申', '辛酉', '壬戌', '癸亥');
  public static $ZHI_XING = array('', '建', '除', '滿', '平', '定', '執', '破', '危', '成', '收', '開', '閉');
  public static $TIAN_SHEN = array('', '青龍', '明堂', '天刑', '朱雀', '金匱', '天德', '白虎', '玉堂', '天牢', '玄武', '司命', '勾陳');
  private static $YI_JI = array('祭祀', '祈福', '求嗣', '開光', '塑繪', '齊醮', '齋醮', '沐浴', '酬神', '造廟', '祀竈', '焚香', '謝土', '出火', '雕刻', '嫁娶', '訂婚', '納采', '問名', '納婿', '歸寧', '安床', '合帳', '冠笄', '訂盟', '進人口', '裁衣', '挽面', '開容', '修墳', '啟鉆', '破土', '安葬', '立碑', '成服', '除服', '開生墳', '合壽木', '入殮', '移柩', '普渡', '入宅', '安香', '安門', '修造', '起基', '動土', '上梁', '豎柱', '開井開池', '作陂放水', '拆卸', '破屋', '壞垣', '補垣', '伐木做梁', '作竈', '解除', '開柱眼', '穿屏扇架', '蓋屋合脊', '開廁', '造倉', '塞穴', '平治道塗', '造橋', '作廁', '築堤', '開池', '伐木', '開渠', '掘井', '掃舍', '放水', '造屋', '合脊', '造畜稠', '修門', '定磉', '作梁', '修飾垣墻', '架馬', '開市', '掛匾', '納財', '求財', '開倉', '買車', '置產', '雇庸', '出貨財', '安機械', '造車器', '經絡', '醞釀', '作染', '鼓鑄', '造船', '割蜜', '栽種', '取漁', '結網', '牧養', '安碓磑', '習藝', '入學', '理發', '探病', '見貴', '乘船', '渡水', '針灸', '出行', '移徙', '分居', '剃頭', '整手足甲', '納畜', '捕捉', '畋獵', '教牛馬', '會親友', '赴任', '求醫', '治病', '詞訟', '起基動土', '破屋壞垣', '蓋屋', '造倉庫', '立券交易', '交易', '立券', '安機', '會友', '求醫療病', '諸事不宜', '餘事勿取', '行喪', '斷蟻', '歸岫', '無');
  ...
  private static $SHEN_SHA = array('無', '天恩', '母倉', '時陽', '生氣', '益後', '青龍', '災煞', '天火', '四忌', '八龍', '覆日', '續世', '明堂', '月煞', '月虛', '血支', '天賊', '五虛', '土符', '歸忌', '血忌', '月德', '月恩', '四相', '王日', '天倉', '不將', '要安', '五合', '鳴吠對', '月建', '小時', '土府', '往亡', '天刑', '天德', '官日', '吉期', '玉宇', '大時', '大敗', '鹹池', '朱雀', '守日', '天巫', '福德', '六儀', '金堂', '金匱', '厭對', '招搖', '九空', '九坎', '九焦', '相日', '寶光', '天罡', '死神', '月刑', '月害', '遊禍', '重日', '時德', '民日', '三合', '臨日', '天馬', '時陰', '鳴吠', '死氣', '地囊', '白虎', '月德合', '敬安', '玉堂', '普護', '解神', '小耗', '天德合', '月空', '驛馬', '天後', '除神', '月破', '大耗', '五離', '天牢', '陰德', '福生', '天吏', '致死', '元武', '陽德', '天喜', '天醫', '司命', '月厭', '地火', '四擊', '大煞', '大會', '天願', '六合', '五富', '聖心', '河魁', '劫煞', '四窮', '勾陳', '觸水龍', '八風', '天赦', '五墓', '八專', '陰錯', '四耗', '陽錯', '四廢', '三陰', '小會', '陰道沖陽', '單陰', '孤辰', '陰位', '行狠', '了戾', '絕陰', '純陽', '七鳥', '歲薄', '陰陽交破', '陰陽俱錯', '陰陽擊沖', '逐陣', '陽錯陰沖', '七符', '天狗', '九虎', '成日', '天符', '孤陽', '絕陽', '純陰', '六蛇', '陰神', '解除', '陽破陰沖');
  ...
  public static $PENG_ZU_GAN = array('', '甲不開倉財物耗散', '乙不栽植千株不長', '丙不修竈必見災殃', '丁不剃頭頭必生瘡', '戊不受田田主不祥', '己不破券二比並亡', '庚不經絡織機虛張', '辛不合醬主人不嘗', '壬不泱水更難提防', '癸不詞訟理弱敵強');

  public static $PENG_ZU_ZHI = array('', '子不問卜自惹禍殃', '醜不冠帶主不還鄉', '寅不祭祀神鬼不嘗', '卯不穿井水泉不香', '辰不哭泣必主重喪', '巳不遠行財物伏藏', '午不苫蓋屋主更張', '未不服藥毒氣入腸', '申不安床鬼祟入房', '酉不會客醉坐顛狂', '戌不吃犬作怪上床', '亥不嫁娶不利新郎');

  public static $NUMBER = array('〇', '一', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二');

  public static $MONTH = array('', '正', '二', '三', '四', '五', '六', '七', '八', '九', '十', '冬', '臘');

  public static $SEASON = array('', '孟春', '仲春', '季春', '孟夏', '仲夏', '季夏', '孟秋', '仲秋', '季秋', '孟冬', '仲冬', '季冬');

  public static $SHENG_XIAO = array('', '鼠', '牛', '虎', '兔', '龍', '蛇', '馬', '羊', '猴', '雞', '狗', '豬');

  public static $DAY = array('', '初一', '初二', '初三', '初四', '初五', '初六', '初七', '初八', '初九', '初十', '十一', '十二', '十三', '十四', '十五', '十六', '十七', '十八', '十九', '二十', '廿一', '廿二', '廿三', '廿四', '廿五', '廿六', '廿七', '廿八', '廿九', '三十');

  public static $YUE_XIANG = array('', '朔', '既朔', '蛾眉新', '蛾眉新', '蛾眉', '夕', '上弦', '上弦', '九夜', '宵', '宵', '宵', '漸盈凸', '小望', '望', '既望', '立待', '居待', '寢待', '更待', '漸虧凸', '下弦', '下弦', '有明', '有明', '蛾眉殘', '蛾眉殘', '殘', '曉', '晦');
  ...
  public static $XIU_SONG = array(
    '角' => '角星造作主榮昌，外進田財及女郎，嫁娶婚姻出貴子，文人及第見君王，惟有埋葬不可用，三年之後主瘟疫，起工修築墳基地，堂前立見主人兇。',
    '亢' => '亢星造作長房當，十日之中主有殃，田地消磨官失職，接運定是虎狼傷，嫁娶婚姻用此日，兒孫新婦守空房，埋葬若還用此日，當時害禍主重傷。',
    '氐' => '氐星造作主災兇，費盡田園倉庫空，埋葬不可用此日，懸繩吊頸禍重重，若是婚姻離別散，夜招浪子入房中，行船必定遭沈沒，更生聾啞子孫窮。',
    '房' => '房星造作田園進，錢財牛馬遍山崗，更招外處田莊宅，榮華富貴福祿康，埋葬若然用此日，高官進職拜君王，嫁娶嫦娥至月殿，三年抱子至朝堂。',
    '心' => '心星造作大為兇，更遭刑訟獄囚中，忤逆官非宅產退，埋葬卒暴死相從，婚姻若是用此日，子死兒亡淚滿胸，三年之內連遭禍，事事教君沒始終。',
    '尾' => '尾星造作主天恩，富貴榮華福祿增，招財進寶興家宅，和合婚姻貴子孫，埋葬若能依此日，男清女正子孫興，開門放水招田宅，代代公侯遠播名。',
    '箕' => '箕星造作主高強，歲歲年年大吉昌，埋葬修墳大吉利，田蠶牛馬遍山崗，開門放水招田宅，篋滿金銀谷滿倉，福蔭高官加祿位，六親豐祿樂安康。',
    '鬥' => '鬥星造作主招財，文武官員位鼎台，田宅家財千萬進，墳堂修築貴富來，開門放水招牛馬，旺蠶男女主和諧，遇此吉宿來照護，時支福慶永無災。',
    ...
    '畢' => '畢星造作主光前，買得田園有余錢，埋葬此日添官職，田蠶大熟永豐年，開門放水多吉慶，合家人口得安然，婚姻若得逢此日，生得孩兒福壽全。',
    ...
    '井' => '井星造作旺蠶田，金榜題名第一光，埋葬須防驚卒死，狂顛風疾入黃泉，開門放水招財帛，牛馬豬羊旺莫言，貴人田塘來入宅，兒孫興旺有余錢。',
    '鬼' => '鬼星起造卒人亡，堂前不見主人郎，埋葬此日官祿至，兒孫代代近君王，開門放水須傷死，嫁娶夫妻不久長，修土築墻傷產女，手扶雙女淚汪汪。',
    '柳' => '柳星造作主遭官，晝夜偷閉不暫安，埋葬瘟惶多疾病，田園退盡守冬寒，開門放水遭聾瞎，腰駝背曲似弓彎，更有棒刑宜謹慎，婦人隨客走盤桓。',
    '星' => '星宿日好造新房，進職加官近帝王，不可埋葬並放水，兇星臨位女人亡，生離死別無心戀，要自歸休別嫁郎，孔子九曲殊難度，放水開門天命傷。',
    ...
    '軫' => '軫星臨水造龍宮，代代為官受皇封，富貴榮華增壽祿，庫滿倉盈自昌隆，埋葬文昌來照助，宅舍安寧不見兇，更有為官沾帝寵，婚姻龍子入龍宮。'
  );
  ...
  public static $CHONG = array('午', '未', '申', '酉', '戌', '亥', '子', '醜', '寅', '卯', '辰', '巳');
  ...
  public static $HE_ZHI_6 = array('醜', '子', '亥', '戌', '酉', '申', '未', '午', '巳', '辰', '卯', '寅');
  ...
  /**
   * 獲取HH:mm時刻的地支序號(0到11)，非法的時刻返回0
   * @param string $hm HH:mm時刻
   * @return int 地支序號，0到11
   */
  ...
  /**
   * 將HH:mm時刻轉換為時辰（地支），非法的時刻返回子
   * @param string $hm HH:mm時刻
   * @return string 時辰(地支)，如子
   */
  ...
  /**
   * 獲取日宜
   * @param string $monthGanZhi 月幹支
   * @param string $dayGanZhi 日幹支
   * @return string[] 宜
   */
...
class SolarUtil
{
   ...
   * @var array
   */
  public static $XING_ZUO = array('白羊', '金牛', '雙子', '巨蟹', '獅子', '處女', '天秤', '天蠍', '射手', '摩羯', '水瓶', '雙魚');
  ...
  public static $OTHER_FESTIVAL = array(
    ...
    '2-24' => array('第三世界青年日'),
    '3-1' => array('國際海豹日'),
    '3-3' => array('世界野生動植物日', '全國愛耳日'),
    '3-5' => array('周恩來誕辰紀念日', '中國青年志願者服務日'),
    '3-6' => array('世界青光眼日'),
    '3-7' => array('女生節'),
    '3-12' => array('孫中山逝世紀念日'),
    '3-14' => array('馬克思逝世紀念日', '白色情人節'),
    '3-17' => array('國際航海日'),
    '3-18' => array('全國科技人才活動日', '全國愛肝日'),
    '3-20' => array('國際幸福日'),
    '3-21' => array('世界森林日', '世界睡眠日', '國際消除種族歧視日'),
    '3-22' => array('世界水日'),
    '3-23' => array('世界氣象日'),
    '3-24' => array('世界防治結核病日'),
    '3-29' => array('中國黃花崗七十二烈士殉難紀念日'),
    '4-2' => array('國際兒童圖書日', '世界自閉癥日'),
    '4-4' => array('國際地雷行動日'),
    '4-7' => array('世界衛生日'),
    '4-8' => array('國際珍稀動物保護日'),
    '4-12' => array('世界航天日'),
    '4-14' => array('黑色情人節'),
    '4-15' => array('全民國家安全教育日'),
    '4-22' => array('世界地球日', '列寧誕辰紀念日'),
    '4-23' => array('世界讀書日'),
    '4-24' => array('中國航天日'),
    '4-25' => array('兒童預防接種宣傳日'),
    '4-26' => array('世界知識產權日', '全國瘧疾日'),
    '4-28' => array('世界安全生產與健康日'),
    '4-30' => array('全國交通安全反思日'),
    '5-2' => array('世界金槍魚日'),
    '5-3' => array('世界新聞自由日'),
    '5-5' => array('馬克思誕辰紀念日'),
    '5-8' => array('世界紅十字日'),
    '5-11' => array('世界肥胖日'),
    '5-12' => array('全國防災減災日', '護士節'),
    '5-14' => array('玫瑰情人節'),
    '5-15' => array('國際家庭日'),
    '5-19' => array('中國旅遊日'),
    '5-20' => array('網絡情人節'),
    ...
    '6-8' => array('世界海洋日'),
    '6-11' => array('中國人口日'),
    '6-14' => array('世界獻血日', '親親情人節'),
    '6-17' => array('世界防治荒漠化與幹旱日'),
    '6-20' => array('世界難民日'),
    '6-21' => array('國際瑜伽日'),
    '6-25' => array('全國土地日'),
    '6-26' => array('國際禁毒日', '聯合國憲章日'),
    '7-1' => array('香港回歸紀念日'),
    '7-6' => array('國際接吻日', '朱德逝世紀念日'),
    '7-7' => array('七七事變紀念日'),
    '7-11' => array('世界人口日', '中國航海日'),
    '7-14' => array('銀色情人節'),
    '7-18' => array('曼德拉國際日'),
    '7-30' => array('國際友誼日'),
    '8-3' => array('男人節'),
    ...
    '8-12' => array('國際青年節'),
    '8-14' => array('綠色情人節'),
    '8-19' => array('世界人道主義日', '中國醫師節'),
    '8-22' => array('鄧小平誕辰紀念日'),
    '8-29' => array('全國測繪法宣傳日'),
    '9-3' => array('中國抗日戰爭勝利紀念日'),
    '9-5' => array('中華慈善日'),
    '9-8' => array('世界掃盲日'),
    '9-9' => array('毛澤東逝世紀念日', '全國拒絕酒駕日'),
    '9-14' => array('世界清潔地球日', '相片情人節'),
    '9-15' => array('國際民主日'),
    '9-16' => array('國際臭氧層保護日'),
    '9-17' => array('世界騎行日'),
    '9-18' => array('九一八事變紀念日'),
    ...
    '10-11' => array('國際女童日'),
    '10-10' => array('辛亥革命紀念日'),
    '10-13' => array('國際減輕自然災害日', '中國少年先鋒隊誕辰日'),
    '10-14' => array('葡萄酒情人節'),
    '10-16' => array('世界糧食日'),
    '10-17' => array('全國扶貧日'),
    '10-20' => array('世界統計日'),
    '10-24' => array('世界發展信息日', '程序員節'),
    '10-25' => array('抗美援朝紀念日'),
    '11-5' => array('世界海嘯日'),
    '11-8' => array('記者節'),
    '11-9' => array('全國消防日'),
    ...
    '11-29' => array('國際聲援巴勒斯坦人民日'),
    '12-1' => array('世界艾滋病日'),
    '12-2' => array('全國交通安全日'),
    '12-3' => array('世界殘疾人日'),
    '12-4' => array('全國法制宣傳日'),
    '12-5' => array('世界弱能人士日', '國際志願人員日'),
    '12-7' => array('國際民航日'),
    '12-9' => array('世界足球日', '國際反腐敗日'),
    '12-10' => array('世界人權日'),
    '12-11' => array('國際山岳日'),
    '12-12' => array('西安事變紀念日'),
    '12-13' => array('國家公祭日'),
   ...
   * @param int $year 年
   * @param int $month 月
   * @param int $start 星期幾作為一周的開始，1234560分別代表星期一至星期天
   * @return int 周數
   */
  ...
  /**
   * 獲取兩個日期之間相差的天數（如果日期a比日期b小，天數為正，如果日期a比日期b大，天數為負）
   * @param $ay int 年a
   * @param $am int 月a
   * @param $ad int 日a
   * @param $by int 年b
...
class EightChar
{
   ...
   */
  public static $MONTH_ZHI = array('', '寅', '卯', '辰', '巳', '午', '未', '申', '酉', '戌', '亥', '子', '醜');

  /**
   * @var array 長生十二神
   */
  public static $CHANG_SHENG = array('長生', '沐浴', '冠帶', '臨官', '帝旺', '衰', '病', '死', '墓', '絕', '胎', '養');
  ...
  /**
   * 獲取流派
   * @return int 流派，2晚子時日柱按當天，1晚子時日柱按明天
   */
  ...
  /**
   * 設置流派
   * @param int $sect 流派，2晚子時日柱按當天，1晚子時日柱按明天
   */
  ...
  /**
   * 獲取年柱地支藏幹，由於藏幹分主氣、余氣、雜氣，所以返回結果可能為1到3個元素
   * @return string[] 天幹
   */
  ...
  /**
   * 獲取年柱地支十神，由於藏幹分主氣、余氣、雜氣，所以返回結果可能為1到3個元素
   * @return string[] 十神
   */
  ...
  /**
   * 獲取月柱地支藏幹，由於藏幹分主氣、余氣、雜氣，所以返回結果可能為1到3個元素
   * @return string[] 天幹
   */
  ...
  /**
   * 獲取月柱地支十神，由於藏幹分主氣、余氣、雜氣，所以返回結果可能為1到3個元素
   * @return string[] 十神
   */
  ...
  /**
   * 獲取日柱地支藏幹，由於藏幹分主氣、余氣、雜氣，所以返回結果可能為1到3個元素
   * @return string[] 天幹
   */
  ...
  /**
   * 獲取日柱地支十神，由於藏幹分主氣、余氣、雜氣，所以返回結果可能為1到3個元素
   * @return string[] 十神
   */
  ...
  /**
   * 獲取時柱地支藏幹，由於藏幹分主氣、余氣、雜氣，所以返回結果可能為1到3個元素
   * @return string[] 天幹
   */
  ...
  /**
   * 獲取時柱地支十神，由於藏幹分主氣、余氣、雜氣，所以返回結果可能為1到3個元素
   * @return string[] 十神
   */
   ...
   * 獲取運
   * @param int $gender 性別，1男，0女
   * @param int $sect 流派，1按天數和時辰數計算，3天1年，1天4個月，1時辰10天；2按分鐘數計算
   * @return Yun 運
   */
...
/**
 * 三伏
 * 從夏至後第3個庚日算起，初伏為10天，中伏為10天或20天，末伏為10天。當夏至與立秋之間出現4個庚日時中伏為10天，出現5個庚日則為20天。
 *
 * @package com\nlf\calendar
 */
class Fu
...
class LunarTime
{
  ...
  /**
   * 通過指定農歷年月日時分秒獲取時辰
   * @param int $lunarYear 年（農歷）
   * @param int $lunarMonth 月（農歷），1到12，閏月為負，即閏2月=-2
   * @param int $lunarDay 日（農歷），1到30
   * @param int $hour 小時（公歷）
   * @param int $minute 分鐘（公歷）
   * @param int $second 秒鐘（公歷）
   * @return LunarTime
   */
  ...
  /**
   * 獲取值時九星（時家紫白星歌訣：三元時白最為佳，冬至陽生順莫差，孟日七宮仲一白，季日四綠發萌芽，每把時辰起甲子，本時星耀照光華，時星移入中宮去，順飛八方逐細查。夏至陰生逆回首，孟歸三碧季加六，仲在九宮時起甲，依然掌中逆輪跨。）
   * @return NineStar 值時九星
   */
  public function getNineStar()
  {
    ...
    if (strpos('子午卯酉', $dayZhi) !== false) {
      $start = $asc ? 1 : 9;
    } else if (strpos('辰戌醜未', $dayZhi) !== false) {
      $start = $asc ? 4 : 6;
    }
...
class Lunar
{
   ...
   * @var string[]
   */
  public static $JIE_QI = array('冬至', '小寒', '大寒', '立春', '雨水', '驚蟄', '春分', '清明', '谷雨', '立夏', '小滿', '芒種', '夏至', '小暑', '大暑', '立秋', '處暑', '白露', '秋分', '寒露', '霜降', '立冬', '小雪', '大雪');

  /**
   * 實際的節氣表
   * @var string[]
   */
  public static $JIE_QI_IN_USE = array('DA_XUE', '冬至', '小寒', '大寒', '立春', '雨水', '驚蟄', '春分', '清明', '谷雨', '立夏', '小滿', '芒種', '夏至', '小暑', '大暑', '立秋', '處暑', '白露', '秋分', '寒露', '霜降', '立冬', '小雪', '大雪', 'DONG_ZHI', 'XIAO_HAN', 'DA_HAN', 'LI_CHUN', 'YU_SHUI', 'JING_ZHE');
  ...
  /**
   * 日對應的天幹下標（八字流派1，晚子時日柱算明天），0-9
   * @var int
   */
  private $dayGanIndexExact;

  /**
   * 日對應的天幹下標（八字流派2，晚子時日柱算當天），0-9
   * @var int
   */
  ...
  /**
   * 日對應的地支下標（八字流派1，晚子時日柱算明天），0-9
   * @var int
   */
  private $dayZhiIndexExact;

  /**
   * 日對應的地支下標（八字流派1，晚子時日柱算當天），0-9
   * @var int
   */
  private $dayZhiIndexExact2;

  /**
   * 月對應的天幹下標（以節交接當天起算），0-9
   * @var int
   */
  ...
  /**
   * 月對應的天幹下標（最精確的，供八字用，以節交接時刻起算），0-9
   * @var int
   */
  ...
  /**
   * 年對應的天幹下標（最精確的，供八字用，以立春交接時刻為起點），0-9
   * @var int
   */
  ...
  /**
   * 獲取幹支紀年（年柱）（以正月初一作為新年的開始）
   * @return string 年份的幹支（年柱），如辛亥
   */
  ...
  /**
   * 獲取幹支紀月（月柱）（以節交接當天起算）
   * <p>月天幹口訣：甲己丙寅首，乙庚戊寅頭。丙辛從庚寅，丁壬壬寅求，戊癸甲寅居，周而覆始流。</p>
   * <p>月地支：正月起寅</p>
   *
   * @return string 幹支紀月（月柱），如己卯
   */
  ...
  {
    if (strpos('甲子,乙醜,丙寅,丁卯,戊辰,已巳',$dayInGanZhi) !== false) {
      $p = '震';
    } else if (strpos('丙子,丁醜,戊寅,已卯,庚辰,辛巳',$dayInGanZhi) !== false) {
      $p = '離';
    } else if (strpos('戊子,已醜,庚寅,辛卯,壬辰,癸巳',$dayInGanZhi) !== false) {
      $p = '中';
    } else if (strpos('庚子,辛醜,壬寅,癸卯,甲辰,乙巳',$dayInGanZhi) !== false) {
      $p = '兌';
    } else if (strpos('壬子,癸醜,甲寅,乙卯,丙辰,丁巳',$dayInGanZhi) !== false) {
      $p = '坎';
    } else {
   ...
   * @return string[] 八字（男性也稱乾造，女性也稱坤造）
   */
  ...
  /**
   * 獲取八字天幹十神，日柱十神為日主，其余三柱根據天幹十神表查詢
   * @return string[] 八字天幹十神
   */
  ...
  /**
   * 獲取值年九星（流年紫白星起例歌訣：年上吉星論甲子，逐年星逆中宮起；上中下作三元匯，一上四中七下兌。）
  ...
  /**
   * 獲取值月九星（月紫白星歌訣：子午卯酉八白起，寅申巳亥二黑求，辰戌醜未五黃中。）
  ...
  /**
   * 獲取值日九星（日家紫白星歌訣：日家白法不難求，二十四氣六宮周；冬至雨水及谷雨，陽順一七四中遊；夏至處暑霜降後，九三六星逆行求。）
  ...
  /**
   * 獲取節氣表（節氣名稱:公歷），節氣交接時刻精確到秒，以冬至開頭，按先後順序排列
   * @return Solar[] 節氣表
   */
  ...
  /**
   * 獲取最近的節氣，如果未找到匹配的，返回null
   * @param $forward bool 是否順推，true為順推，false為逆推
   * @param $conditions array|null 過濾條件，如果設置過濾條件，僅返回匹配該名稱的
   * @param $wholeDay bool 是否按天計
   * @return JieQi|null 節氣
   */
  ...
  /**
   * 獲取當天節氣對象，如果無節氣，返回null
   * @return JieQi|null 節氣對象
   */
...
class LunarMonth
{
  ...
  public function toFullString()
  {
    return $this->year . '年' . ($this->isLeap() ? '閏' : '') . abs($this->month) . '月(' . $this->dayCount . '天)';
  }
  ...
  /**
   * 通過農歷年月初始化
   * @param int $lunarYear 農歷年
   * @param int $lunarMonth 農歷月：1-12，閏月為負數，如閏2月為-2
   * @return LunarMonth
   */
  ...
  /**
   * 獲取農歷月
   * @return int 農歷月：1-12，閏月為負數，如閏2月為-2
   */
  public function getMonth()
  {
    return $this->month;
...
class LunarYear
{
  ...
  /**
   * 獲取農歷月
   * @param int $lunarMonth 月，1-12，閏月為負數，如閏2月為-2
  ...
  protected function getZaoByGan($index, $name)
  {
    ...
    return preg_replace('/幾/', LunarUtil::$NUMBER[$offset + 1], $name, 1);
  }
  ...
  {
    return $this->getZaoByZhi(0, '幾鼠偷糧');
  }

  public function getCaoZi()
  {
    return $this->getZaoByZhi(0, '草子幾分');
  }
  ...
  {
    return $this->getZaoByZhi(3, '花收幾分');
  }

  public function getZhiShui()
  {
    return $this->getZaoByZhi(4, '幾龍治水');
  }

  public function getTuoGu()
  {
    return $this->getZaoByZhi(6, '幾馬馱谷');
  }

  public function getQiangMi()
  {
    return $this->getZaoByZhi(9, '幾雞搶米');
  }
  ...
  {
    return $this->getZaoByZhi(11, '幾屠共豬');
  }

  public function getJiaTian()
  {
    return $this->getZaoByGan(0, '甲田幾分');
  }

  public function getFenBing()
  {
    return $this->getZaoByGan(2, '幾人分餅');
  }
  ...
  {
    return $this->getZaoByGan(2, $this->getZaoByZhi(2, '幾人幾丙'));
  }

  public function getRenChu()
  {
    return $this->getZaoByGan(3, $this->getZaoByZhi(2, '幾人幾鋤'));
  }
  ...
  public function getYun()
  {
    return LunarYear::$YUN[(int)(($this->year + 2696) / 20) % 9] . '運';
  }
...
class NineStar
{
   ...
   * @var array
   */
  public static $COLOR = array('白', '黒', '碧', '綠', '黃', '白', '赤', '白', '紫');
   ...
   * @var array
   */
  public static $POSITION = array('坎', '坤', '震', '巽', '中', '乾', '兌', '艮', '離');

  /**
   * 北鬥九星
   * @var array
   */
  public static $NAME_BEI_DOU = array('天樞', '天璇', '天璣', '天權', '玉衡', '開陽', '搖光', '洞明', '隱元');

  /**
   * 玄空九星（玄空風水）
   * @var array
   */
  public static $NAME_XUAN_KONG = array('貪狼', '巨門', '祿存', '文曲', '廉貞', '武曲', '破軍', '左輔', '右弼');

  /**
   * 奇門九星（奇門遁甲，也稱天盤九星）
   * @var array
   */
  public static $NAME_QI_MEN = array('天蓬', '天芮', '天沖', '天輔', '天禽', '天心', '天柱', '天任', '天英');

  /**
   * 八門（奇門遁甲）
   * @var array
   */
  public static $BA_MEN_QI_MEN = array('休', '死', '傷', '杜', '', '開', '驚', '生', '景');

  /**
   * 太乙九神（太乙神數）
   * @var array
   */
  public static $NAME_TAI_YI = array('太乙', '攝提', '軒轅', '招搖', '天符', '青龍', '鹹池', '太陰', '天乙');

  /**
   * 太乙九神對應類型
   * @var array
   */
  public static $TYPE_TAI_YI = array('吉神', '兇神', '安神', '安神', '兇神', '吉神', '兇神', '吉神', '吉神');

  /**
   * 太乙九神歌訣（太乙神數）
   * @var array
   */
  public static $SONG_TAI_YI = array('門中太乙明，星官號貪狼，賭彩財喜旺，婚姻大吉昌，出入無阻擋，參謁見賢良，此行三五里，黑衣別陰陽。', '門前見攝提，百事必憂疑，相生猶自可，相克禍必臨，死門並相會，老婦哭悲啼，求謀並吉事，盡皆不相宜，只可藏隱遁，若動傷身疾。', '出入會軒轅，凡事必纏牽，相生全不美，相克更憂煎，遠行多不利，博彩盡輸錢，九天玄女法，句句不虛言。', '招搖號木星，當之事莫行，相克行人阻，陰人口舌迎，夢寐多驚懼，屋響斧自鳴，陰陽消息理，萬法弗違情。', '五鬼為天符，當門陰女謀，相克無好事，行路阻中途，走失難尋覓，道逢有尼姑，此星當門值，萬事有災除。', '神光躍青龍，財氣喜重重，投入有酒食，賭彩最興隆，更逢相生旺，休言克破兇，見貴安營寨，萬事總吉同。', '吾將為鹹池，當之盡不宜，出入多不利，相克有災情，賭彩全輸盡，求財空手回，仙人真妙語，愚人莫與知，動用虛驚退，反覆逆風吹。', '坐臨太陰星，百禍不相侵，求謀悉成就，知交有覓尋，回風歸來路，恐有殃伏起，密語中記取，慎乎莫輕行。', '迎來天乙星，相逢百事興，運用和合慶，茶酒喜相迎，求謀並嫁娶，好合有天成，禍福如神驗，吉兇甚分明。');

  /**
   * 吉兇（玄空風水）
   * @var array
   */
  public static $LUCK_XUAN_KONG = array('吉', '兇', '兇', '吉', '兇', '吉', '兇', '吉', '吉');

  /**
   * 吉兇（奇門遁甲）
   * @var array
   */
  public static $LUCK_QI_MEN = array('大兇', '大兇', '小吉', '大吉', '大吉', '大吉', '小兇', '小吉', '小兇');

  /**
   * 陰陽（奇門遁甲）
   * @var array
   */
  public static $YIN_YANG_QI_MEN = array('陽', '陰', '陽', '陽', '陽', '陰', '陰', '陽', '陰');
...
class Solar
{
  ...
  /**
   * 獲取薪資比例(感謝 https://gitee.com/smr1987)
   * @return int 薪資比例：1/2/3
   */
...
class XiaoYun
{
   ...
   * 初始化
   * @param int $index 序數
   * @param DaYun $daYun 大運
   * @param bool $forward 是否順推
   */
...
class Tao
{
  ...
  public function getFestivals()
  {
    ...
    if (strcmp('冬至', $jq) === 0) {
      $l[] = new TaoFestival('元始天尊聖誕');
    } else if (strcmp('夏至', $jq) === 0) {
      $l[] = new TaoFestival('靈寶天尊聖誕');
    }
    // 八節日
