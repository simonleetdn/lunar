...
class LunarUtil
{
  ...
  public static $PENG_ZU_ZHI = array('', '子不問卜自惹禍殃', '丑不冠帶主不還鄉', '寅不祭祀神鬼不嘗', '卯不穿井水泉不香', '辰不哭泣必主重喪', '巳不遠行財物伏藏', '午不苫蓋屋主更張', '未不服藥毒氣入腸', '申不安床鬼祟入房', '酉不會客醉坐顛狂', '戌不吃犬作怪上床', '亥不嫁娶不利新郎');
  ...
  public static $XIU_SONG = array(
    ...
    '箕' => '箕星造作主高強，歲歲年年大吉昌，埋葬修墳大吉利，田蠶牛馬遍山崗，開門放水招田宅，篋滿金銀穀滿倉，福蔭高官加祿位，六親豐祿樂安康。',
    '鬥' => '鬥星造作主招財，文武官員位鼎台，田宅家財千萬進，墳堂修築貴富來，開門放水招牛馬，旺蠶男女主和諧，遇此吉宿來照護，時支福慶永無災。',
    '牛' => '牛星造作主災危，九橫三災不可推，家宅不安人口退，田蠶不利主人衰，嫁娶婚姻皆自損，金銀財穀漸無之，若是開門並放水，牛豬羊馬亦傷悲。',
...
class Lunar
{
   ...
   * @var string[]
   */
  public static $JIE_QI = array('冬至', '小寒', '大寒', '立春', '雨水', '驚蟄', '春分', '清明', '穀雨', '立夏', '小滿', '芒種', '夏至', '小暑', '大暑', '立秋', '處暑', '白露', '秋分', '寒露', '霜降', '立冬', '小雪', '大雪');

  /**
   * 實際的節氣表
   * @var string[]
   */
  public static $JIE_QI_IN_USE = array('DA_XUE', '冬至', '小寒', '大寒', '立春', '雨水', '驚蟄', '春分', '清明', '穀雨', '立夏', '小滿', '芒種', '夏至', '小暑', '大暑', '立秋', '處暑', '白露', '秋分', '寒露', '霜降', '立冬', '小雪', '大雪', 'DONG_ZHI', 'XIAO_HAN', 'DA_HAN', 'LI_CHUN', 'YU_SHUI', 'JING_ZHE');
  ...
  /**
   * 獲取值月九星（月紫白星歌訣：子午卯酉八白起，寅申巳亥二黑求，辰戌丑未五黃中。）
  ...
  /**
   * 獲取值日九星（日家紫白星歌訣：日家白法不難求，二十四氣六宮周；冬至雨水及穀雨，陽順一七四中遊；夏至處暑霜降後，九三六星逆行求。）
...
class LunarYear
{
  ...
  {
    return $this->getZaoByZhi(6, '幾馬馱穀');
  }
