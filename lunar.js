;(function(root,factory){
  ...
  var LunarUtil = (function(){
    return {
      ...
      PENGZU_GAN:['', '{tg.jia}不開倉財物耗散', '{tg.yi}不栽植千株不長', '{tg.bing}不修竈必見災殃', '{tg.ding}不剃頭頭必生瘡', '{tg.wu}不受田田主不祥', '{tg.ji}不破券二比並亡', '{tg.geng}不經絡織機虛張', '{tg.xin}不合醬主人不嘗', '{tg.ren}不泱水更難提防', '{tg.gui}不詞訟理弱敵強'],
      PENGZU_ZHI:['', '{dz.zi}不問卜自惹禍殃', '{dz.chou}不冠帶主不還鄉', '{dz.yin}不祭祀神鬼不嘗', '{dz.mao}不穿井水泉不香', '{dz.chen}不哭泣必主重喪', '{dz.si}不遠行財物伏藏', '{dz.wu}不苫蓋屋主更張', '{dz.wei}不服藥毒氣入腸', '{dz.shen}不安床鬼祟入房', '{dz.you}不會客醉坐顛狂', '{dz.xu}不吃犬作怪上床', '{dz.hai}不嫁娶不利新郎'],
      ...
      XIU_SONG:{
        ...
        '{xx.di}': '氐星造作主災兇，費盡田園倉庫空，埋葬不可用此日，懸繩吊頸禍重重，若是婚姻離別散，夜招浪子入房中，行船必定遭沈沒，更生聾啞子孫窮。',
        ...
        '{xx.ji}': '箕星造作主高強，歲歲年年大吉昌，埋葬修墳大吉利，田蠶牛馬遍山崗，開門放水招田宅，篋滿金銀谷滿倉，福蔭高官加祿位，六親豐祿樂安康。',
        ...
        '{xx.xu}': '虛星造作主災殃，男女孤眠不一雙，內亂風聲無禮節，兒孫媳婦伴人床，開門放水遭災禍，虎咬蛇傷又卒亡，三三五五連年病，家破人亡不可當。',
        '{xx.wei}': '危星不可造高樓，自遭刑吊見血光，三年孩子遭水厄，後生出外永不還，埋葬若還逢此日，周年百日取高堂，三年兩載一悲傷，開門放水到官堂。',
        ...
        '{xx.can}': '參星造作旺人家，文星照耀大光華，只因造作田財旺，埋葬招疾哭黃沙，開門放水加官職，房房子孫見田加，婚姻許遁遭刑克，男女朝開幕落花。',
        '{xx.jing}': '井星造作旺蠶田，金榜題名第一光，埋葬須防驚卒死，狂顛風疾入黃泉，開門放水招財帛，牛馬豬羊旺莫言，貴人田塘來入宅，兒孫興旺有余錢。',
        '{xx.gui}': '鬼星起造卒人亡，堂前不見主人郎，埋葬此日官祿至，兒孫代代近君王，開門放水須傷死，嫁娶夫妻不久長，修土築墻傷產女，手扶雙女淚汪汪。',
      ...
      OTHER_FESTIVAL:{'1-4':['接神日'],'1-5':['隔開日'],'1-7':['人日'],'1-8':['谷日','順星節'],'1-9':['天日'],'1-10':['地日'],'1-20':['天穿節'],'1-25':['填倉節'],'1-30':['正月晦'],'2-1':['中和節'],'2-2':['社日節'],'3-3':['上巳節'],'5-20':['分龍節'],'5-25':['會龍節'],'6-6':['天貺節'],'6-24':['觀蓮節'],'6-25':['五谷母節'],'7-15':['中元節'],'7-22':['財神節'],'7-29':['地藏節'],'8-1':['天灸日'],'10-1':['寒衣節'],'10-10':['十成節'],'10-15':['下元節'],'12-7':['驅儺日'],'12-16':['尾牙'],'12-24':['祭竈日']},
  ...
  var NineStar = (function(){
    ...
    return {
      ...
      NAME_TAI_YI:['太乙','攝提','軒轅','招搖','天符','青龍','鹹池','太陰','天乙'],
      TYPE_TAI_YI:['吉神','兇神','安神','安神','兇神','吉神','兇神','吉神','吉神'],
      SONG_TAI_YI:['門中太乙明，星官號貪狼，賭彩財喜旺，婚姻大吉昌，出入無阻擋，參謁見賢良，此行三五里，黑衣別陰陽。','門前見攝提，百事必憂疑，相生猶自可，相克禍必臨，死門並相會，老婦哭悲啼，求謀並吉事，盡皆不相宜，只可藏隱遁，若動傷身疾。','出入會軒轅，凡事必纏牽，相生全不美，相克更憂煎，遠行多不利，博彩盡輸錢，九天玄女法，句句不虛言。','招搖號木星，當之事莫行，相克行人阻，陰人口舌迎，夢寐多驚懼，屋響斧自鳴，陰陽消息理，萬法弗違情。','五鬼為天符，當門陰女謀，相克無好事，行路阻中途，走失難尋覓，道逢有尼姑，此星當門值，萬事有災除。','神光躍青龍，財氣喜重重，投入有酒食，賭彩最興隆，更逢相生旺，休言克破兇，見貴安營寨，萬事總吉同。','吾將為鹹池，當之盡不宜，出入多不利，相克有災情，賭彩全輸盡，求財空手回，仙人真妙語，愚人莫與知，動用虛驚退，反覆逆風吹。','坐臨太陰星，百禍不相侵，求謀悉成就，知交有覓尋，回風歸來路，恐有殃伏起，密語中記取，慎乎莫輕行。','迎來天乙星，相逢百事興，運用和合慶，茶酒喜相迎，求謀並嫁娶，好合有天成，禍福如神驗，吉兇甚分明。'],
      LUCK_QI_MEN:['大兇','大兇','小吉','大吉','大吉','大吉','小兇','小吉','小兇'],
  ...
  var FotoUtil = (function(){
    ...
    return {
      ...
      FESTIVAL:{
        ...
        '9-1': [_s, _f('南鬥誕', xl), _f('北鬥九星降世', dj, false, '此九日俱宜齋戒')],
        '9-3': [_d, _f('五瘟神誕')],
        '9-6': [_l],
        '9-8': [_t],
  ...
  var TaoUtil = (function(){
    ...
    return {
      ...
      FESTIVAL: {
        ...
        '4-28': [_f('神農先帝誕')],
        '5-1': [_f('南極長生大帝聖誕')],
        '5-5': [_f('地臘之辰', '地臘，此日五帝會於南方三炁丹天'), _f('南方雷祖聖誕'), _f('地祗溫元帥聖誕'), _f('雷霆鄧天君聖誕')],
        '5-11': [_f('城隍爺聖誕')],
        ...
        '9-7': [_f('北鬥九皇降世之辰')],
        '9-8': [_f('北鬥九皇降世之辰')],
        '9-9': [_f('北鬥九皇降世之辰'), _f('鬥姥元君聖誕'), _f('重陽帝君聖誕'), _f('玄天上帝飛升'), _f('酆都大帝聖誕')],
        '9-22': [_f('增福財神誕')],
        '9-23': [_f('薩翁真君聖誕')],
        '9-28': [_f('五顯靈官馬元帥聖誕')],
